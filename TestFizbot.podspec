...
Pod::Spec.new do |s|
  s.name             = 'TestFizbot'
  s.version          = '0.1.0'
  s.summary          = 'A short description of TestFizbot.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Alkın Çakıralar/TestFizbot'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Alkın Çakıralar' => 'a.cakiralar@gmail.com' }
  s.source           = { :git => 'https://github.com/Alkın Çakıralar/TestFizbot.git', :tag => s.version.to_s }
